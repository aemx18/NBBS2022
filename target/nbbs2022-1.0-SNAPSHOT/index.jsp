...
<body>
    <div class="banner">
        <div class="navbar">
            <img src="img/logoName.png" class="logo" id="logo-index">
            <ul>
    ...
    <script type="text/javascript">
        ...
        {
            location.href = "customer/cust-createAcc.jsp";
        }
        document.getElementById("worker").onclick = function ()
        {
            location.href = "worker/worker-createAcc.jsp";
        }
        document.getElementById("admin").onclick = function ()
        {
            location.href = "admin/admin-createAcc.jsp";
        }
    </script>
</body>
</html>